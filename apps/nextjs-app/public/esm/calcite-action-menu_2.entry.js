import { r as registerInstance, c as createEvent, h, F as Fragment, g as getElement, f as forceUpdate, H as Host } from './index-9b24d2d4.js';
import { g as getRoundRobinIndex } from './array-9ff99c1b.js';
import { t as toAriaBoolean, i as isPrimaryPointerButton, h as focusElement, j as focusFirstTabbable, q as queryElementRoots } from './dom-67db067b.js';
...
import { C as CSS$1, I as ICONS, S as SLOTS } from './resources-149d82da.js';
import { f as filterComputedPlacements, c as connectFloatingUI, b as defaultOffsetDistance, u as updateAfterClose, a as disconnectFloatingUI, r as reposition, F as FloatingCSS } from './floating-ui-75c36572.js';
...
let ActionMenu = class {
  ...
  renderMenuButton() {
    ...
    const menuButtonSlot = (h("slot", { name: SLOTS.trigger, onSlotchange: this.setMenuButtonEl }, h("calcite-action", { class: CSS$1.defaultTrigger, icon: ICONS.menu, scale: scale, text: label, textEnabled: expanded,
