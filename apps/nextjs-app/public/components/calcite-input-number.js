...
import { a as getSlotted, i as isPrimaryPointerButton, n as setRequestedIcon, g as getElementProp, b as getElementDir } from './dom.js';
...
let InputNumber = class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
...
InputNumber = /*@__PURE__*/ proxyCustomElement(InputNumber, [1, "calcite-input-number", {
    "alignment": [513],
    "autofocus": [516],
    "clearable": [516],
    "disabled": [516],
