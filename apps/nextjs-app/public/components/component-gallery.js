...
import { d as defineCustomElement$4 } from './component-gallery-filter-sidebar2.js';
import { d as defineCustomElement$3 } from './component-gallery-grid2.js';
import { d as defineCustomElement$2 } from './component-gallery-search-input2.js';
...
function buildSearchInput(query = '', filters = {}) {
  // Builds a query like:
  // $and: [
  //   { 
  //     $or: [
  ...
  }); // TS missing this is building an array
  if (query.length > 0) {
...
const componentGalleryCss = ":host{display:block}.gallery-container{display:grid;grid-template-columns:200px 1fr;grid-template-rows:auto 1fr;grid-template-areas:\". search\"\n    \"filters componentgrid\";grid-gap:1rem}component-gallery-search-input{grid-area:search}component-gallery-filter-sidebar{grid-area:filters}component-gallery-grid{grid-area:componentgrid}";

const ComponentGallery$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  static get watchers() { return {
    "query": ["handleQuery"],
    "filters": ["handleFilterUpdated"]
  }; }
  static get style() { return componentGalleryCss; }
}, [1, "component-gallery", {
    "filters": [1040],
    "query": [1537],
    "components": [32],
    "filteredComponents": [32],
    "filterOptions": [32]
  }]);
function defineCustomElement$1() {
  ...
  const components = ["component-gallery", "calcite-button", "calcite-card", "calcite-checkbox", "calcite-chip", "calcite-icon", "calcite-label", "calcite-loader", "calcite-tree", "calcite-tree-item", "component-gallery-filter-sidebar", "component-gallery-grid", "component-gallery-search-input"];
  components.forEach(tagName => { switch (tagName) {
    case "component-gallery":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, ComponentGallery$1);
      }
      break;
    case "calcite-button":
      if (!customElements.get(tagName)) {
...
const ComponentGallery = ComponentGallery$1;
const defineCustomElement = defineCustomElement$1;

export { ComponentGallery, defineCustomElement };
