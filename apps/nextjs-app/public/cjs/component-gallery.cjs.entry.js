...
const ComponentGallery = class {
  ...
  render() {
    return (index.h("div", { class: "gallery-container" }, index.h("component-gallery-search-input", { query: this.query, onSearch: (event) => this.handleQuery(event.detail) }), index.h("component-gallery-filter-sidebar", { filters: this.filterOptions, onFiltersUpdated: (event) => this.handleFilterUpdated(event.detail) }), index.h("component-gallery-grid", { components: this.filteredComponents })));
  }
...
ComponentGallery.style = componentGalleryCss;

exports.component_gallery = ComponentGallery;

//# sourceMappingURL=component-gallery.cjs.entry.js.map