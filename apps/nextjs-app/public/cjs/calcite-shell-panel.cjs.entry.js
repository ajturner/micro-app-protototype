...
const math = require('./math-adbe1a0a.js');
...
let ShellPanel = class {
  ...
  render() {
    ...
    const contentNode = (index.h("div", { class: { [CSS.content]: true, [CSS.contentDetached]: detached }, hidden: collapsed, key: "content", style: allowResizing && contentWidth ? { width: `${contentWidth}px` } : null,
      // eslint-disable-next-line react/jsx-sort-props
      ref: this.storeContentEl }, this.renderHeader(), index.h("div", { class: CSS.contentBody }, index.h("slot", null))));
...
//# sourceMappingURL=calcite-shell-panel.cjs.entry.js.map