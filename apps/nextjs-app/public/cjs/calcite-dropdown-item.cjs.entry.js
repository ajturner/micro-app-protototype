    ...
    const slottedContent = this.iconStart && this.iconEnd
      ...
      : this.iconStart
        ...
        : this.iconEnd
          ...
          : contentNode;
    const contentEl = !this.href ? (slottedContent) : (index.h("a", { "aria-label": this.label, class: CSS.link, href: this.href, rel: this.rel, tabIndex: -1, target: this.target,
...
//# sourceMappingURL=calcite-dropdown-item.cjs.entry.js.map