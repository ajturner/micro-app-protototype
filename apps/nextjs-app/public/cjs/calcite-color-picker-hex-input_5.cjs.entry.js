...
const index$1 = require('./index-4922fbcf.js');
const index = require('./index-f7a91565.js');
const dom = require('./dom-5643dc8d.js');
const loadable = require('./loadable-0d54a318.js');
const utils = require('./utils-6ed8639c.js');
...
let Tab = class {
  constructor(hostRef) {
    index$1.registerInstance(this, hostRef);
    this.calciteInternalTabRegister = index$1.createEvent(this, "calciteInternalTabRegister", 6);
  ...
  render() {
    ...
    return (index$1.h(index$1.Host, { "aria-labelledby": this.labeledBy, id: id }, index$1.h("div", { class: "container", role: "tabpanel", tabIndex: this.selected ? 0 : -1 }, index$1.h("section", null, index$1.h("slot", null)))));
  }
  connectedCallback() {
...
let TabNav = class {
  constructor(hostRef) {
    index$1.registerInstance(this, hostRef);
    this.calciteTabChange = index$1.createEvent(this, "calciteTabChange", 6);
    this.calciteInternalTabChange = index$1.createEvent(this, "calciteInternalTabChange", 6);
  ...
  render() {
    ...
    return (index$1.h(index$1.Host, { role: "tablist" }, index$1.h("div", { class: "tab-nav", onScroll: this.handleContainerScroll,
      // eslint-disable-next-line react/jsx-sort-props
      ref: (el) => (this.tabNavEl = el) }, index$1.h("div", { class: "tab-nav-active-indicator-container",
      // eslint-disable-next-line react/jsx-sort-props
      ref: (el) => (this.activeIndicatorContainerEl = el) }, index$1.h("div", { class: "tab-nav-active-indicator", style: indicatorStyle,
      // eslint-disable-next-line react/jsx-sort-props
      ref: (el) => (this.activeIndicatorEl = el) })), index$1.h("slot", null))));
  }
  //--------------------------------------------------------------------------
  //
  //  Event Listeners
...
let TabTitle = class {
  constructor(hostRef) {
    index$1.registerInstance(this, hostRef);
    this.calciteTabsActivate = index$1.createEvent(this, "calciteTabsActivate", 6);
    this.calciteInternalTabsActivate = index$1.createEvent(this, "calciteInternalTabsActivate", 6);
    this.calciteInternalTabsFocusNext = index$1.createEvent(this, "calciteInternalTabsFocusNext", 6);
    this.calciteInternalTabsFocusPrevious = index$1.createEvent(this, "calciteInternalTabsFocusPrevious", 6);
    this.calciteInternalTabsFocusFirst = index$1.createEvent(this, "calciteInternalTabsFocusFirst", 6);
    this.calciteInternalTabsFocusLast = index$1.createEvent(this, "calciteInternalTabsFocusLast", 6);
    this.calciteInternalTabTitleRegister = index$1.createEvent(this, "calciteInternalTabTitleRegister", 6);
    this.calciteInternalTabIconChanged = index$1.createEvent(this, "calciteInternalTabIconChanged", 6);
    //--------------------------------------------------------------------------
    //
    //  Private State/Props
    //
  ...
  render() {
    const id = this.el.id || this.guid;
    const iconStartEl = (index$1.h("calcite-icon", { class: { [CSS.titleIcon]: true, [CSS.iconStart]: true }, flipRtl: this.iconFlipRtl === "start" || this.iconFlipRtl === "both", icon: this.iconStart, scale: this.scale === "l" ? "m" : "s" }));
    const iconEndEl = (index$1.h("calcite-icon", { class: { [CSS.titleIcon]: true, [CSS.iconEnd]: true }, flipRtl: this.iconFlipRtl === "end" || this.iconFlipRtl === "both", icon: this.iconEnd, scale: this.scale === "l" ? "m" : "s" }));
    return (index$1.h(index$1.Host, { "aria-controls": this.controls, "aria-selected": dom.toAriaBoolean(this.selected), id: id, role: "tab", tabIndex: this.selected ? 0 : -1 }, index$1.h("div", { class: {
        container: true,
        [CSS.iconPresent]: this.iconStart || this.iconEnd ? true : null,
        [CSS.containerHasText]: this.hasText
      },
      // eslint-disable-next-line react/jsx-sort-props
      ref: (el) => { var _a; return (_a = this.resizeObserver) === null || _a === void 0 ? void 0 : _a.observe(el); } }, this.iconStart ? iconStartEl : null, index$1.h("slot", null), this.iconEnd ? iconEndEl : null)));
  }
...
let Tabs = class {
  ...
  //--------------------------------------------------------------------------
  render() {
    return (index$1.h(index$1.Fragment, null, index$1.h("slot", { name: SLOTS.titleGroup }), index$1.h("section", null, index$1.h("slot", null))));
  }
  //--------------------------------------------------------------------------
  //
  //  Event Listeners
...
//# sourceMappingURL=calcite-color-picker-hex-input_5.cjs.entry.js.map